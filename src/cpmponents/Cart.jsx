...

    {
      cart?.items?.length == 0 ? (
        ...
        <div className='text-center my-5'>
            <button className="btn btn-warning mx-3" style={{fontWeight:'bold'}}  onClick={()=> navigate ("/")}>Continue Shopping...</button>
        ...
        cart?.items?.map((product) => <div key={product._id} className='container p-3 bg-dark my-5 text-center'>
          <div style={{display:'flex',
            ...
            <div className='cart_action'>
              <button className="btn btn-warning mx-3" style={{fontWeight:'bold'}} onClick={() => decreseQty(product.productId, 1)}  >Qty--</button>
              <button
